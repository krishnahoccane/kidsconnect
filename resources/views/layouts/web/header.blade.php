...
<head>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="{{ asset('ui/assets/vendor/css/rtl/core.css') }}"
    ...
    <link rel="stylesheet" href="{{ asset('ui/assets/vendor/libs/spinkit/spinkit.css') }}" />
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-header small text-uppercase">
                        <span class="menu-header-text" data-i18n="Apps & Pages">Users</span>
                    </li>
                    <li class="menu-item {{ request()->is('adminUsers') ? 'active' : '' }}">
                        <a href="{{ url('adminUsers') }}" class="menu-link">
                            <i class="menu-icon tf-icons ti ti-users"></i>
                            <div data-i18n="users">Manage Admin Users</div>
                        </a>
                    </li>
                    ...
                    <li class="menu-item {{ request()->is('feedback') ? 'active' : '' }}">
                        <a href="{{ url('feedback') }}" class="menu-link">
                            ...
                            <div data-i18n="message">Manage Feedback</div>
                        </a>
                    </li>
                    ...
                    <li class="menu-item {{ request()->is('termsAndconditions') ? 'active' : '' }}">
                        <a href="{{ url('termsAndconditions') }}" class="menu-link">
                            <i class="menu-icon tf-icons ti ti-files"></i>
                            <div data-i18n="tc">Terms & Conditions</div>
                        </a>
                    </li>
                    <li class="menu-item {{ request()->is('privacyPolicy') ? 'active' : '' }}">
                        <a href="{{ url('privacyPolicy') }}" class="menu-link">
                            <i class="menu-icon tf-icons ti ti-files"></i>
                            <div data-i18n="pp">Privacy Policy</div>
                        </a>
                    </li>
                    ...
                    <li class="menu-header small text-uppercase">
                        <span class="menu-header-text" data-i18n="Reports">Data</span>
                    </li>
                    <li class="menu-item">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            <i class="menu-icon tf-icons ti ti-report"></i>
                            <div data-i18n="Total Registrations">Reports</div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item {{ request()->is('totalRegistrations') ? 'active' : '' }}">
                                <a href="{{ url('totalRegistrations') }}" class="menu-link">
                                    <div data-i18n="Total Registrations">Total Registrations</div>
                                </a>
                            </li>
                            <li class="menu-item {{ request()->is('totalCalendarschedules') ? 'active' : '' }}">
                                <a href="{{ url('totalCalendarschedules') }}" class="menu-link">
                                    <div data-i18n="Total Calendar schedules">Total Calendar schedules</div>
                                </a>
                            </li>
                            <li class="menu-item {{ request()->is('appFeedbacks') ? 'active' : '' }}">
                                <a href="{{ url('appFeedbacks') }}" class="menu-link">
                                    <div data-i18n="View App Feedbacks">View App Feedbacks</div>
                                </a>
                            </li>
                        </ul>
                    </li>
                                        ...
                                        <ul class="list-group list-group-flush">
                                            <li
                                                ...
                                                <div class="d-flex">
                                                    <div class="flex-shrink-0 me-3">
                                                        <div class="avatar">
                                                            <img src="{{ asset('ui/assets/img/avatars/1.png') }}" alt
                                            ...
                                            <li
                                                ...
                                                <div class="d-flex">
                                                    <div class="flex-shrink-0 me-3">
                                                        <div class="avatar">
                                                            <img src="{{ asset('ui/assets/img/avatars/2.png') }}" alt
                                                                class="h-auto rounded-circle">
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1">
                                            ...
                                            <li
                                                ...
                                                <div class="d-flex">
                                                    <div class="flex-shrink-0 me-3">
                                                        <div class="avatar">
                                                            <img src="{{ asset('ui/assets/img/avatars/9.png') }}" alt
                                                                class="h-auto rounded-circle">
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1">
                                            ...
                                            <li
                                                ...
                                                <div class="d-flex">
                                                    <div class="flex-shrink-0 me-3">
                                                        <div class="avatar">
                                                            <img src="{{ asset('ui/assets/img/avatars/5.png') }}" alt
                                                                class="h-auto rounded-circle">
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1">
                                            ...
                                            <li
                                                ...
                                                <div class="d-flex">
                                                    <div class="flex-shrink-0 me-3">
                                                        <div class="avatar">
                                                            <img src="{{ asset('ui/assets/img/avatars/6.png') }}" alt
                                                                class="h-auto rounded-circle">
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1">
